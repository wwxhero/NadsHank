...
public class SteamVR_ManagerPed : SteamVR_Manager
{
	...
	SteamVR_ManagerPed()
	{
		...
		m_transition = new Transition[] {
									...
									, new Transition(State.pre_cnn, State.pre_cnn, FRONT, actInspecAvatar_f)
									...
									, new Transition(State.post_cnn, State.post_cnn, FRONT, actInspecAvatar_f)
									...
									, new Transition(State.pre_calibra, State.pre_calibra, FRONT, actInspecAvatar_f)
									...
									, new Transition(State.post_calibra, State.post_calibra, FRONT, actInspecAvatar_f)
									...
									, new Transition(State.tracking_inspec, State.tracking_inspec, FRONT, actInspecAvatar_f)
