...
public class TrackerCalibrationController : MonoBehaviour {
    ...
    [HideInInspector]
    public bool tracker_calibration;
    ...
    void Start() {
        ...
        count1 = false;
        tracker = 1;
        tracker_calibration = false;

        modelHead = GameObject.Find("Other Targets/Head Tracker");
        modelLeftWrist = GameObject.Find("Other Targets/Left Hand Tracker");
        modelRightWrist = GameObject.Find("Other Targets/Right Hand Tracker");
    ...
    void Update() {
        ...
        else
        {
            ...
            // Sort on y to determine the highest tracker.  It will be placed in tracker_array[0] and will be mapped to the head
            ...
            // Find the minimum of the two lowest trackers and assign it to tracker_array[1].  It will be assigned to the left hand
            // The remaining tracker will be placed in tracker_array[2].  It will be assigned to the right hand.
            if (tracker_array[1].transform.position.z < tracker_array[2].transform.position.z)
            {
                GameObject tmp = tracker_array[1];
                tracker_array[1] = tracker_array[2];
                tracker_array[2] = tmp;
            }
            ...
            modelHead.GetComponent<SteamVR_TrackedObject>().index = (SteamVR_TrackedObject.EIndex)index1;
            modelLeftWrist.GetComponent<SteamVR_TrackedObject>().index = (SteamVR_TrackedObject.EIndex)index2;
            modelRightWrist.GetComponent<SteamVR_TrackedObject>().index = (SteamVR_TrackedObject.EIndex)index3;
