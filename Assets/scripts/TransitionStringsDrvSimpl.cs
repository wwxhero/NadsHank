public class TransitionStringsDrvSimpl
{
	public static string [] s_Desc = {
		...
		, "Press 'Down arrow' to move mirror closer, 'Up arrow' to move mirror farthur away."												//3
		, "Press 'F' to inspect avatar from front."																							//4
		, "Press 'R' to inspect avatar from right."																							//5
		, "Press 'U' to inspect avatar from top."																							//6
		, "Press 'Enter' to attach trackers."																								//7
		, "Press 'Backspace' to re-align trackers with avatar."																				//10
		, "Press 'F' to inspect avatar from front."																							//11
		, "Press 'R' to inspect avatar from right."																							//12
		, "Press 'U' to inspect avatar from top."																							//13
		, "Press 'Enter' to complete tracker setup."																						//14
		, "Press 'Up arrow' to pull avatar upward, 'Down arrow' to push avatar downward"													//15
		, "Press 'F' to inspect avatar from front."																							//16
		, "Press 'R' to inspect avatar from right."																							//17
		, "Press 'U' to inspect avatar from top."																							//18
